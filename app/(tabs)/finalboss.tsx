/**
 * Final Boss — GeoGiganto
 *
 * The Grand Cartographer: questions drawn from ALL 4 worlds combined.
...
const BOSS = {
  name:    'The Grand Cartographer',
  icon:    '🌍',
  tagline: 'Knowledge from across the world',
};
    ...
    return (
      <SafeAreaView className="flex-1 bg-background items-center justify-center px-6">
        ...
        <Text className="text-2xl font-bold text-foreground mb-2 text-center">
          {defeated ? 'GAME COMPLETE!' : 'Defeated by the world…'}
        </Text>
