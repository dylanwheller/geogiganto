...
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.smartypants.geogiganto';
...
export default function ProfileScreen() {
  ...
  const displayName = authUser?.displayName ?? localUser?.name ?? 'GeoGiganto Explorer';
            ...
            <View className="flex-row items-center gap-4">
              ...
              <View>
                ...
                {email
                  ...
                  : <Text className="text-primary font-medium text-sm">GeoGiganto Explorer</Text>}
            ...
            <View className="bg-card rounded-2xl p-4 border border-border">
              <View className="flex-row items-center gap-3">
                ...
                <View className="flex-1">
                  <Text className="text-foreground font-bold font-nunito">GeoGiganto Premium</Text>
