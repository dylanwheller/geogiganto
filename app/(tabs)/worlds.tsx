    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <CopilotView collapsable={false}>
          ...
          <Text className="text-2xl font-bold text-foreground">Geography Worlds</Text>
        </CopilotView>
      </CopilotStep>
          ...
          >
            ...
            >
              <View className="flex-1 p-5 justify-between">
                ...
                <View>
                  <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>The Grand Cartographer</Text>
                  <Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12, marginTop: 2 }}>
                    {finalBossDefeated ? 'Defeated — you are a GeoGiganto Legend!' : 'All worlds combined · 1 000 XP'}
                  </Text>
                </View>
              </View>
            </View>
