...
const EXPLAIN_PREF_KEY = '@geogiganto_explain_pref';
...
const BOSS_CONFIG: Record<number, BossConfig> = {
  1: {
    ...
    accentColor:    '#f97316',
    taunts:         [
      "Your geography knowledge is scattered! 🌋",
      "You couldn't even name a continent!",
      "My plasma is hotter than your brain!",
      "Pathetic! You're no geographer!",
    ],
    timeoutTaunt:   "Lost on the map! Time's up!",
    victoryMessage: "The Plasma Tyrant is extinguished!",
    defeatMessage:  "The Plasma Tyrant scorched you!",
  },
  2: {
    bgColors:       ['#2e1065', '#130a2e'],
    accentColor:    '#a855f7',
    taunts:         [
      "You can't weather my questions! 🌪️",
      "My storms are bigger than your knowledge!",
      "Jupiter laughs at your answers!",
      "You'd be lost in my Great Red Spot!",
    ],
    timeoutTaunt:   "Swept away by my storm!",
    victoryMessage: "The Storm Colossus is subdued!",
    defeatMessage:  "The Storm Colossus overwhelmed you!",
  },
  3: {
    bgColors:       ['#082f49', '#031220'],
    accentColor:    '#06b6d4',
    taunts:         [
      "Your knowledge is absolutely frozen! ❄️",
      "Cold as the void — just like your brain!",
      "Pluto knows more than you!",
      "You're lost in the Kuiper Belt!",
    ],
    timeoutTaunt:   "Frozen solid! No time left!",
    victoryMessage: "The Void Leviathan is banished!",
    defeatMessage:  "The Void Leviathan swallowed you whole!",
  },
  4: {
    bgColors:       ['#3f2d00', '#1f1600'],
    accentColor:    '#eab308',
    taunts:         [
      "You'd miss even a full moon eclipse! 🌑",
      "Your space facts are in the dark!",
      "Not even the Moon would orbit you!",
      "Deep space has more answers than you!",
    ],
    timeoutTaunt:   "Lost in the dark — no time left!",
    victoryMessage: "The Eclipse Wraith is dispelled!",
    defeatMessage:  "The Eclipse Wraith consumed you!",
  },
};
