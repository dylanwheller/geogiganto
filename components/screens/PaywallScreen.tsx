/**
 * PaywallScreen — GeoGiganto
 *
 * Two-option paywall:
 *   1. GeoGiganto Only — R100 (smartypants_geogiganto)
...
const PLAY_STORE_URL =
  'https://play.google.com/store/apps/details?id=com.smartypants.geogiganto';

const APP_EMOJI = '🌍';
const APP_NAME  = 'GeoGiganto';

const INDIVIDUAL_FEATURES = [
  'Unlock all 4 GeoGiganto worlds',
