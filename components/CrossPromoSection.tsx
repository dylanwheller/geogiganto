...
const OTHER_APPS: PromoApp[] = [
  ...
  {
    name: 'HistoryHadro',
    tagline: 'History adventures through the ages',
    icon: require('@/assets/images/historyhadro-icon.png'),
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.smartypants.historyhadro',
  },
  {
    name: 'CompSciCarno',
